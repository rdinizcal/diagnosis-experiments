...
| `evaluation` | trace_check_timeout_sec 3600, cache_enabled true; `parallel_workers` pinned to 1 (serial, deterministic) by the runner |
| `heuristics.interval_inference` | enabled, mode `label`, empirical_validation_k 2 |
| `heuristics.two_tier_timeout` | enabled, low 60 s, high 3000 s, escalate once per formula |
